...
_RAW_PATTERNS = (
    r"^/api/(?:stat|goals|codex|items|skills|quests|weekly|events/status|secret-realms|hunt/status|gacha/pity|gacha/status|pvp/opponents|pvp/records|sect/member|sect/buffs|convert/options|achievements)/([^/?#]+)$",
